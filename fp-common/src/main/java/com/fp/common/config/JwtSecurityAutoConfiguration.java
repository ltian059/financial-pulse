...
public class JwtSecurityAutoConfiguration {
    ...
    public SecurityFilterChain defaultJwtSecurityFilterChain(HttpSecurity http, JwtDecoder jwtDecoder) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("swagger-ul/**", "/v3/api-docs/**", "/swagger-ui/**").permitAll()
