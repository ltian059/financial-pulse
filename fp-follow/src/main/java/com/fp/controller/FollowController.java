...
public class FollowController {
    ...
    public ResponseEntity<PageResponseDTO<FollowResponseDTO>> listFollower(
            @Valid ListFollowersRequestDTO listFollowersRequestDTO) {
    ...
    public ResponseEntity<PageResponseDTO<FollowResponseDTO>> listFollowing(
            @Valid ListFollowingsRequestDTO requestDTO) {
